...
function DashboardPage() {
    ...
    const loadStats = async ()=>{
        const [s, a, c, e] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('students').select('id', {
                count: 'exact',
                head: true
            }).eq('is_active', true),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('agencies').select('id', {
                count: 'exact',
                head: true
            }).eq('is_active', true),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('consultations').select('id', {
                count: 'exact',
                head: true
            }),
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('exam_results').select('id', {
                count: 'exact',
                head: true
            })
        ]);
...
_s(DashboardPage, "5/jYpqkPivNIONVtX3qEPe+dIsI=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "QuickLink");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_24116641._.js.map