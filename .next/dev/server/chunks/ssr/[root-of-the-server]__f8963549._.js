...
function NewStudentPage() {
    ...
    const checkAuth = async ()=>{
        ...
        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('agencies').select('*').eq('is_active', true).order('agency_number');
    ...
    const handleSubmit = async (e)=>{
        ...
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('students').insert(payload);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f8963549._.js.map